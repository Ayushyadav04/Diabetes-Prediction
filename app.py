...
import pickle
pickle.dump(model,open(r"model_saved",'wb'))
model_loaded=pickle.load(open(r"model_saved",'rb'))
...
import pickle
import numpy as np
app = Flask(__name__,template_folder=r'template',static_folder=r'static')
model_loaded=pickle.load(open(r"model_saved",'rb'))
@app.route('/')
def home():
